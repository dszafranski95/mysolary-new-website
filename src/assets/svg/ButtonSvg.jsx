const ButtonSvg = (white) => (
  <>
    {/* Define green gradients for the button */}
    <svg width="0" height="0">
      <defs>
        ...
        <linearGradient id="btn-right" x1="100%" y1="0%" x2="0%" y2="0%">
          <stop offset="0%" style={{ stopColor: "#00CC00", stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: "#66FF66", stopOpacity: 1 }} />
        </linearGradient>
        <linearGradient id="btn-top" x1="0%" y1="100%" x2="0%" y2="0%">
          <stop offset="0%" style={{ stopColor: "#66FF66", stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: "#00CC00", stopOpacity: 1 }} />
        </linearGradient>
        <linearGradient id="btn-bottom" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: "#00CC00", stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: "#66FF66", stopOpacity: 1 }} />
        </linearGradient>
      </defs>
